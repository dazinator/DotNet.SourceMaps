    ...
    public class Base64VariableLengthQuantityFormat
    {
        ...
        public static string Encode(int inValue)
        {
            ...
            do
            {
                ...
                builder.Append(Base64Format.Encode(currentDigit));
        ...
        public static Tuple<int, string> Decode(string inString)
        {
            ...
            for (var i = 0; i < inString.Length; i++)
            {
                ...
                else
                {
                    ...
                    var rest = inString.Substring(i + 1);
                    return new Tuple<int, string>(value, rest);
                }
            }
